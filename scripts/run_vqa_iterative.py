...
parser.add_argument("--generation_batch_size", type=int, default=20, help="Batch size for question generation with LM.")
parser.add_argument("--vqa_batch_size", type=int, default=20, help="Batch size for VQA with VLM.")
