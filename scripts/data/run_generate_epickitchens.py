...
from travel.data.epickitchens import EpicKitchensMistakeDetectionDataset
...
print("Generating Epic Kitchens dataset...")
dataset = EpicKitchensMistakeDetectionDataset(data_split=args.partition, 
