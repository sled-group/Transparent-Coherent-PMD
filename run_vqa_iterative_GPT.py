...
if worker_index == 0:
    ...
    accuracy_metrics_by_threshold, coherence_metrics, other_metrics = compile_accuracy_and_coherence_metrics(all_labels_eval, all_probs_eval, all_coherence_metrics, all_results_dicts_eval, MISTAKE_DETECTION_THRESHOLDS, args.unsure_range)
